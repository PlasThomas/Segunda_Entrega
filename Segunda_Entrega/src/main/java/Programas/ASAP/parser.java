...
import static ASAP.parser.addMessage;

/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu May 23 09:43:45 CST 2024
  */
      ...
      switch (CUP$parser$act_num)
        {
          ...
          case 6: // T ::= BOOLEAN 
            {
              Object RESULT =null;
		 Programas.ASAP.parser.addMessage("Type: boolean");
          ...
          case 5: // T ::= INTEGER 
            {
              Object RESULT =null;
		 Programas.ASAP.parser.addMessage("Type: integer");
              CUP$parser$result = parser.getSymbolFactory().newSymbol("T",3, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		 ...
		 Programas.ASAP.parser.addMessage("Variable ");
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // D ::= VAR V COLON T SEMICOLON 
            {
              Object RESULT =null;
		 Programas.ASAP.parser.addMessage("Declaration found");
          ...
          case 1: // S ::= D 
            {
              Object RESULT =null;
		 Programas.ASAP.parser.addMessage("Parse successful!");
